...
// so this page doesn't hold or refresh any token. It just asks the backend
...
/**
 * Boot-time "who am I?" probe. Returns the user record from
 * auth.romaine.life (via this app's /api/auth/me) if there's a valid
 * session, or null.
 */
